...
class ExcludeArrivalBeforeDepartureInSegmentChainFilterImplTest {

    @Test
    @DisplayName("exclude flight when segment departure before arrival")
    void arrivalBeforeDepartureInSegment_whenSegmentArrivalBeforeDeparture_thenExcludeFlight() {
        var filter = new ExcludeArrivalBeforeDepartureInSegmentChainFilterImpl();
        Segment incorrect1 = new Segment(LocalDateTime.now().plus(Duration.ofMinutes(25)),
        ...
        Segment incorrect2 = new Segment(LocalDateTime.now().plus(Duration.ofHours(1)),
                LocalDateTime.now().plus(Duration.ofMinutes(55)));
    ...
    void arrivalBeforeDepartureInSegment_whenEmptyList_thenReturnEmptyList() {
        var filter = new ExcludeArrivalBeforeDepartureInSegmentChainFilterImpl();
