...
class FlightFiltrationNoneMatchImplTest {
    private final FlightFiltration filtration = new FlightFiltrationNoneMatchImpl();
    ...
    @Test
    @DisplayName("return full list when predicate is false")
    void getFilteredFlightsList_whenPredicateFalse_thenReturnFullList() {
    ...
    @Test
    @DisplayName("return empty list when predicate is true")
    void getFilteredFlightsList_whenPredicateTrue_thenReturnEmptyList() {
    ...
    @Test
    @DisplayName("return full list when all predicates are false")
    void getFilteredFlightsList_whenAllPredicatesFalse_thenReturnFullList() {
        List<Flight> expected = getFlightsList();
    ...
    @Test
    @DisplayName("return empty list when all predicates are true")
    void getFilteredFlightsList_whenAllPredicatesTrue_thenReturnEmptyList() {
        List<Flight> flights = getFlightsList();
    ...
    @Test
    @DisplayName("return empty list when not all predicates are false")
    void getFilteredFlightsList_whenNotAllPredicatesFalse_thenReturnEmptyList() {
        List<Flight> flights = getFlightsList();
        Predicate<Flight> predicate1 = flight -> true;
        Predicate<Flight> predicate2 = flight -> false;
        var predicates = List.of(predicate1, predicate2);
